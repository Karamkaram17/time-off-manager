...
(() => {
  ...
  var DateUtils = {
    parseDate(dateStr) {
      ...
      if (day === void 0 || month === void 0 || year === void 0 || Number.isNaN(day) || Number.isNaN(month) || Number.isNaN(year)) {
  ...
  var TimeOffCalculator = class {
    ...
    forEachAccrualMonth(accrualCutoffDate, callback2) {
      for (let monthCursor = DateUtils.getMonthStart(this.employmentStartDate); monthCursor <= accrualCutoffDate; monthCursor = new Date(monthCursor.getFullYear(), monthCursor.getMonth() + 1, 1)) {
  ...
  var DashboardUI = class {
    constructor(selectors) {
      ...
      this.elements = {
        ...
        remainingTimeOffManager: queryRequiredElement(selectors.remainingTimeOffManager),
        updatedInfo: queryRequiredElement(selectors.updatedInfo),
        remainingToday: queryRequiredElement(selectors.remainingToday),
        remainingThisMonthInfo: queryRequiredElement(selectors.remainingThisMonthInfo),
        remainingYear: queryRequiredElement(selectors.remainingYear),
        yearProjectionInfo: queryRequiredElement(selectors.yearProjectionInfo)
      };
      this.sortButtons = Array.from(document.querySelectorAll("[data-sort-key]"));
